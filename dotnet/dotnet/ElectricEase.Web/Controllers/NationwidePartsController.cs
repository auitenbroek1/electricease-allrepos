...
{
    public class NationwidePartsController : Controller
    {
        //
        // GET: /NationwideParts/
        ...
        public ActionResult Index()
        {
            ...
            masterpartslist = new MasterServiceBLL().GetNationwidepartscategory();
        ...
        public ActionResult AddNationwidePartsDetails(Parts_DetailsInfo Model)
        {
            ...
            response = PartsResponse.AddNationwidePartsDetail(Model);
        ...
        public ActionResult GetNationalPartsList(string PartCatgory = "")
        {
            //PartsMasterBLL PartsResponse = new PartsMasterBLL();
            //ClientMasterBLL ClientResponse = new ClientMasterBLL();
            ...
            //PartsCategoryList parts = new PartsCategoryList();
            //List<PartsCategoryList> partslist = new List<PartsCategoryList>();
            //partslist = new MasterServiceBLL().GetNationalwidePartsCategoryList();
            //parts.Part_Category = "ALL Parts Category";
            //partslist.Add(parts);
            //ViewBag.PartCategory = new SelectList(partslist, "Part_Category", "Part_Category");
            //response = PartsResponse.GetNationalWidePartsDetalisList(PartCatgory);
            return PartialView("_GetNationalPartsList");
        }
        ...
        public ActionResult EditPartsDetails(string PartsNumber = "")
        {
            ...
            if (PartsNumber.Trim() != "0")
            {
                response = PartsResponse.GetNationawidePartsDetails(PartsNumber);
                if (response.ResultCode > 0)
                {
        ...
        public ActionResult CheckIsExistPartNumber(Parts_DetailsInfo Model)
        {
            ...
            string Loginuser = FormsAuthentication.Decrypt(Request.Cookies[FormsAuthentication.FormsCookieName].Value).Name;
            var result = ClientResponse.GetClientName(Loginuser);
            response = PartsResponse.SuperAdminCheckIsNewPartNumber(Model.Part_Number.Trim());
        ...
        [HttpPost]
        public ActionResult DeletePartsDetails(string PartsNumber = "")
        {
            PartsMasterBLL PartsResponse = new PartsMasterBLL();
            ServiceResult<int> response = new ServiceResult<int>();
            if (PartsNumber.Trim() != "0")
            {
                string Loginuser = FormsAuthentication.Decrypt(Request.Cookies[FormsAuthentication.FormsCookieName].Value).Name;
                ViewBag.LoginUser = Loginuser;
                response = PartsResponse.DeleteNotionaWidePartsDetails(PartsNumber);
                return Json(response.Message, JsonRequestBehavior.AllowGet);
            }
            else
            {
        ...
        //                                                {
        //                                                    totalpartsimported++;
        //                                                    Super_Admin_Parts_Details parts = new Super_Admin_Parts_Details();
        ...
        //                                                    {
        //                                                        //if (dReader.GetValue(2) != null && dReader.GetValue(2) != DBNull.Value && dReader.GetValue(4) != null && dReader.GetValue(4) != DBNull.Value)
        //                                                        //{
        ...
        //                                                        if (string.IsNullOrEmpty(dReader.GetValue(5).ToString()))
        //                                                        {
        //                                                            parts.LaborUnit = 0;
        //                                                        }
        //                                                        else
        ...
        //                                                        Super_Admin_Parts_Details dbparts = db.Super_Admin_Parts_Details.Where(x => x.Part_Number == parts.Part_Number).FirstOrDefault();
        ...
        //                                                                //db.Super_Admin_Parts_Details.Add(dbparts);

        //                                                                //To update the existing Nationwide Assembly Parts
        //                                                                List<Super_Admin_Assemblies_Parts> assemblyPartsList = db.Super_Admin_Assemblies_Parts.Where(x => x.Part_Number == parts.Part_Number).ToList();

        //                                                                foreach (Super_Admin_Assemblies_Parts assemblyPart in assemblyPartsList)
        //                                                                {
        ...
        //                                                                    assemblyToProcess.Add(assemblyPart.Assemblies_Id);
        //                                                                }
        //                                                                totalpartsupdated++;
        //                                                            }
        //                                                            else
        //                                                            {
        //                                                                _log.Info(parts.Part_Number + " - Failed due to invalid Part Number or Part Category.");
        ...
        //                                                                db.Super_Admin_Parts_Details.Add(parts);
        ...
        //                                                            else
        //                                                            {
        //                                                                _log.Info(parts.Part_Number + " - No value is Nationwide Assembly Parts.");
        //                                                                invalidparts += parts.Part_Number + "<br/>";
        //                                                                PartsNames Addpartname = new PartsNames();
        //                                                                Addpartname.Partnumber = parts.Part_Number;
        //                                                                Addpartname.Category = parts.Part_Category;
        ...
        //                                                {
        //                                                    using (SqlCommand recalcCmd = new SqlCommand("EE_RecalcNationwideAssembly", con))
        //                                                    {
        //                                                        recalcCmd.CommandType = CommandType.StoredProcedure;

        //                                                        recalcCmd.Parameters.Add("@AssemblyList", SqlDbType.NVarChar).Value = assembliesList.ToString();
        //                                                        recalcCmd.Parameters.Add("@UpdatedBy", SqlDbType.NVarChar).Value = "Admin Excel";
        ...
        public ActionResult ExportParts()
        {
            ClientMasterBLL ClientResponse = new ClientMasterBLL();
        ...
        public ActionResult GetNationalparts(string PartCatgory = "")
        {
            PartsMasterBLL PartsResponse = new PartsMasterBLL();
            ClientMasterBLL ClientResponse = new ClientMasterBLL();
            ServiceResultList<Parts_DetailsInfoList> response = new ServiceResultList<Parts_DetailsInfoList>();
            ...
            ViewBag.PartCategory = new SelectList(partslist, "Part_Category", "Part_Category");
            response = PartsResponse.GetNationalWidePartsDetalisList(PartCatgory);
            return PartialView("_GetNationalparts", response.ListData);
        }

        public JsonResult GetNationwidePartsList()
        {
            var partsList = PartsResponse.GetNationalWidePartsDetalisList("");
            var jsonResult = Json( new { data = partsList.ListData }, JsonRequestBehavior.AllowGet);
                    ...
                    if (ext == ".xlsx")
                    {
                        ...
                        using (OleDbConnection excelConnection = new OleDbConnection(excelConnString))
                        {
                            ...
                            using (OleDbDataAdapter da = new OleDbDataAdapter("Select * from [Sheet1$]", excelConnection))
                            {
                                ...
                                DataTable dtImportPartsReport = PartsResponse.ImportNationWideParts(dtExcelParts);
        ...
        public void GenerateExcelReport()
        {
            ...
            try
            {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=NationwidePartsImport-Report.xlsx");
