...
class MigrateArmorElectricJobs extends Command
{
    ...
    protected $signature = 'triforce:migrate-armor-electric-jobs';

    protected $description = 'Migrate Armor Electric Jobs';

    private $member = 'Armor Electric Company';
    ...
    private $job_list = [4261, 4524, 4586, 4575, 4574, 4543, 4474, 4460, 4176, 4351, 4388];
