...
class ImportCraftsmanParts2 extends Command
{
    protected $signature = 'triforce:import-craftsman-parts-2';

    protected $description = 'Update Craftsman Parts 2';
