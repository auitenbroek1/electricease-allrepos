...
export const useJobExpense = (data: any) => {
  const { id } = data
  ...
  const onDeleteClick = async () => {
    const response = await axios.delete(`/api/jobs/expenses/${id}`)
  ...
  const save = async () => {
    ...
    if (id) {
      ...
      try {
        const response = await axios.patch(`/api/jobs/expenses/${id}`, payload)
