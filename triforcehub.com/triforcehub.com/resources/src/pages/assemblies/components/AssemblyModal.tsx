...
import { AssemblyModalCollection } from './AssemblyModalCollection'

export const AssemblyModal = (props: any) => {
  ...
  let handleSelectChange = (items: any) => {
    setSelected(items)
  }
            ...
            <div className="inline-block h-[80vh] w-[80vw] transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
              <div className="flex h-full flex-col">
                <div className="flex-none bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  ...
                  <Dialog.Description>
                    Select assemblies you would like to add
                  </Dialog.Description>
                </div>
