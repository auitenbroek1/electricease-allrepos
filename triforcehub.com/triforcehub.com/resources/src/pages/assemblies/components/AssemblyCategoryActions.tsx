...
export const AssemblyCategoryActions = () => {
  ...
  const handleEdit = async () => {
    console.log(`edit`)
    navigate(`/app/assemblies/categories/${item.id}/edit`)
  }

  //

  const { destroy } = useController({ endpoint: `/api/assemblies/categories` })
      ...
      >
        <Modal.Content>
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <div className="text-lg font-medium leading-6">Delete category</div>
            <div className="mt-2">
