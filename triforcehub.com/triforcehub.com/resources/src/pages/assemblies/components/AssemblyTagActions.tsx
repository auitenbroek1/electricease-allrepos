...
export const AssemblyTagActions = () => {
  ...
  const handleEdit = async () => {
    console.log(`edit`)
    navigate(`/app/assemblies/tags/${item.id}/edit`)
  }

  //

  const { destroy } = useController({ endpoint: `/api/assemblies/tags` })
  ...
  return (
    <>
      <Actions.Root>
        ...
        <Actions.Portal>
          <Actions.Group>
            <Actions.Title icon={<Cog6ToothIcon />}>Tag Options</Actions.Title>
          </Actions.Group>
          <Actions.Group>
            <Actions.Item
      ...
      >
        <Modal.Content>
          ...
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <div className="text-lg font-medium leading-6">Delete tag</div>
            <div className="mt-2">
