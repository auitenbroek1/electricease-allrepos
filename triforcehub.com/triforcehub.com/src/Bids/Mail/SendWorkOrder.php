...
use Src\Bids\Actions\GenerateWorkOrderAttachmentAction;

class SendWorkOrder extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        if (in_array('work-order', $this->_attachments)) {
            $this->attachData(...(new GenerateWorkOrderAttachmentAction)(
                job: $this->job,
        ...
        return $this->markdown('emails.jobs.work-order.markdown');
    }
}
